                ...
                <div className="accordion" id="accordionCompetencia">
                  <div className="accordion-item">
                    ...
                    <div
                      ...
                      data-bs-parent="#accordionCompetencia"
                    >
                          ...
                          <div className="container">
                            {skills.map(({ cor, titulo, nomes }, index) => (
                              <div className="mb-3" key={index}>
                                <h5
                                  className={`text-${Array.isArray(cor) ? cor[0] : cor}`}
                                >
                                  {titulo}
                                </h5>
                                  ...
                                  {nomes?.map((item, i) => {
                                    if (typeof item === "object" && item.Icon) {
                                      return (
                                        <div
                                          key={i}
                                          className={`badge bg-${Array.isArray(cor) ? cor[1] : cor} text-center gap-2 fs-6 px-1 py-1`}
                                          style={{ display: "flex" }}
                                        >
                                          <div
                                            style={{
